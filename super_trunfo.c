...
int main()
{
  ...
  printf("Populacao: Carta %d venceu (%d)\n", (populacao_1 < populacao_2) + 1, populacao_1 < populacao_2);
  printf("Area: Carta %d venceu (%d)\n",(area_1 < area_2) + 1, area_1 < area_2);
  printf("PIB: Carta %d venceu (%d)\n", (PIB_1 < PIB_2) + 1, PIB_1 < PIB_2);
  printf("Pontos Turisticos: Carta %d venceu (%d)\n", (pts_turisticos_1 < pts_turisticos_2) + 1, pts_turisticos_1 < pts_turisticos_2);
  printf("Densidade Populacional: Carta %d venceu (%d)\n", (densidade_populacional_1 > densidade_populacional_2) + 1, densidade_populacional_1 > densidade_populacional_2);
  printf("PIB per Capita: Carta %d venceu (%d)\n", (PIB_per_capita_1 < PIB_per_capita_2) + 1, PIB_per_capita_1 < PIB_per_capita_2);
  printf("Super Poder: Carta %d venceu (%d)\n", (super_poder_1 < super_poder_2) + 1, super_poder_1 < super_poder_2);
